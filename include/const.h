...
#define TIMER_RATE_GENERATOR 0x34 /* 00-11-010-0 :
...
#define CRTC_START_ADDR_H 0xC //reg index of video mem start addr (MSB)
#define CRTC_START_ADDR_L 0xD //reg index of video mem start addr (LSB)
#define CURSOR_H 0xE //reg index of sursor position
#define CURSOR_L 0xF
